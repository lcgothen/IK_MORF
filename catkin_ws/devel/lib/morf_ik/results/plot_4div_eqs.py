...
print("Deviation")
print(stats.ttest_ind(data[data['configuration'] == '1 layer, 5 neurons']['deviation'], data[data['configuration'] == '1 layer, 10 neurons']['deviation'], equal_var=False, alternative='less')) 
print(stats.ttest_ind(data[data['configuration'] == '1 layer, 5 neurons']['deviation'], data[data['configuration'] == '2 layers, 10 neurons']['deviation'], equal_var=False, alternative='less')) 
