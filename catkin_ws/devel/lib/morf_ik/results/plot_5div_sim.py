...
filepath = "./devel/lib/morf_ik/results/5div_babbling/"
...
print(stats.f_oneway(dev_vals[1], dev_vals[0], dev_vals[2]))
...
# plt.savefig(filepath + "dur_5div_sim.png")
# plt.close()
...
# plt.savefig(filepath + "dev_5div_sim.png")
# plt.close()
...
# plt.savefig(filepath + "Vdur_5div_sim.png")
# plt.close()
...
# plt.savefig(filepath + "Vdev_5div_sim.png")
# plt.close()