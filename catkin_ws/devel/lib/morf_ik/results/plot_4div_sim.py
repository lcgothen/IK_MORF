...
print("Duration")
print(stats.ttest_ind(data[data['configuration'] == '2 layers, 10 neurons']['duration'], data[data['configuration'] == '1 layer, 5 neurons']['duration'], equal_var=False, alternative='less')) 
print(stats.ttest_ind(data[data['configuration'] == '2 layers, 10 neurons']['duration'], data[data['configuration'] == '1 layer, 10 neurons']['duration'], equal_var=False, alternative='less')) 

print("Deviation")
print(stats.ttest_ind(data[data['configuration'] == '2 layers, 10 neurons']['deviation'], data[data['configuration'] == '1 layer, 5 neurons']['deviation'], equal_var=False, alternative='less')) 
print(stats.ttest_ind(data[data['configuration'] == '2 layers, 10 neurons']['deviation'], data[data['configuration'] == '1 layer, 10 neurons']['deviation'], equal_var=False, alternative='less')) 
...
# plt.savefig(filepath + "dur_4div_sim.png")
# plt.close()
...
# plt.savefig(filepath + "dev_4div_sim.png")
# plt.close()
...
# plt.savefig(filepath + "Vdur_4div_sim.png")
# plt.close()
...
# plt.savefig(filepath + "Vdev_4div_sim.png")
# plt.close()