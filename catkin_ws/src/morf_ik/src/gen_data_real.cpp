    ...
    for(int i=0; i<num; i++)
    {
        for(int j=0; j<num; j++)
        {
            for(int k=0; k<num; k++)
            {
                ...
                if(FL.th2<=0.94 && FL.th3>=step_th2*1.95/0.98*j-3 && step_th3<0) // limit th3 so as to not hit the table
                    break;
                else if(FL.th2<=0.94 && FL.th3<=step_th2*1.95/0.98*j-3 && step_th3>0) // limit th3 so as to not hit the table
                    break;
                else if(k<num-1)
                    FL.th3 += step_th3;
            }
