...
int main(int argc, char **argv)
{
    ...
    //     std::ofstream filterIn;
    //     std::string filterIn_name = std::string("./babbling_data/filtered_input.data");
    //     filterIn.open(filterIn_name);

    //     std::ofstream filterOut;
    //     std::string filterOut_name = std::string("./babbling_data/filtered_output.data");
    //     filterOut.open(filterOut_name);
    ...
    //     allInputFile_name = std::string("./babbling_data/filtered_input.data");
    //     allOutputFile_name = std::string("./babbling_data/filtered_output.data");
    //     // aux_path = std::string("./babbling_data/aux_filtered/");
