...
int main(int argc, char **argv)
{
    ...
    std::string res_name = "./neural_networks/results_" + std::to_string(div) + "div_eqs/" + std::string(train_name);
    std::string dat_name = "./neural_networks/data_" + std::to_string(div) + "div_eqs/" + std::string(train_name);
    ...
    for(int j=0; j<=div; j++)
    {
        for(int k=0; k<=div; k++)
        {
            ...
            {
                std::string filename = "./neural_networks/data_" + std::to_string(div) + "div_eqs/train"+std::to_string(j)+std::to_string(k)+std::to_string(l)+std::string(".data");
                std::string filename_vali = "./neural_networks/data_" + std::to_string(div) + "div_eqs/vali"+std::to_string(j)+std::to_string(k)+std::to_string(l)+std::string(".data");
